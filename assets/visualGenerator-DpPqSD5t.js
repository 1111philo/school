import{G as x}from"./index-CZza8o4z.js";async function w(a,s,c,n={}){const{model:i="flash",aspectRatio:t="16:9",enableGrounding:g=!0}=n;try{const e=new x({apiKey:c}),o=i==="pro"?"gemini-3-pro-image-preview":"gemini-2.5-flash-image",m=`Educational diagram: ${s}.
