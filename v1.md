...
**Purpose**  
Create lesson plan per learning objective.
...
* objective text  
* learner profile  
* optional constraints (time, modality)
...
* Learning Objective restated in first person, measurable, aligned to assessment.  
* 3–6 mastery criteria.  
* 3–6 activities.
...
* a complete JSON schema pack for all entities and agent outputs (copy/paste ready),  
* prompt templates per agent with strict formatting rules,  
* and an orchestration pseudocode spec (state machine \+ retries \+ logging).
